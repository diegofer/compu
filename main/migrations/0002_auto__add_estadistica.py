...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Estadistica'
        db.create_table(u'main_estadistica', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('total', self.gf('django.db.models.fields.IntegerField')()),
            ('en_cola', self.gf('django.db.models.fields.IntegerField')()),
            ('en_revision', self.gf('django.db.models.fields.IntegerField')()),
            ('reparados', self.gf('django.db.models.fields.IntegerField')()),
            ('entregados', self.gf('django.db.models.fields.IntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['Estadistica'])


    def backwards(self, orm):
        # Deleting model 'Estadistica'
        db.delete_table(u'main_estadistica')
    ...
    models = {
        ...
        u'main.estadistica': {
            'Meta': {'object_name': 'Estadistica'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'en_cola': ('django.db.models.fields.IntegerField', [], {}),
            'en_revision': ('django.db.models.fields.IntegerField', [], {}),
            'entregados': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reparados': ('django.db.models.fields.IntegerField', [], {}),
