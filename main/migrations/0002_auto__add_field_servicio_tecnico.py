...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Servicio.tecnico'
        db.add_column(u'main_servicio', 'tecnico',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tecnico_de', null=True, to=orm['main.Persona']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Servicio.tecnico'
        db.delete_column(u'main_servicio', 'tecnico_id')
