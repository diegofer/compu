...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Servicio.precio'
        db.add_column(u'main_servicio', 'precio',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Servicio.precio'
        db.delete_column(u'main_servicio', 'precio')
    ...
    models = {
        ...
        u'main.servicio': {
            ...
            'entregado': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'plazo': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'blank': 'True'}),
            'precio': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
