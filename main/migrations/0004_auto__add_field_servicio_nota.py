...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Servicio.nota'
        db.add_column(u'main_servicio', 'nota',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Servicio.nota'
        db.delete_column(u'main_servicio', 'nota')
    ...
    models = {
        ...
        u'main.servicio': {
            ...
            'plazo': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 2, 0, 0)', 'blank': 'True'}),
